...
const indian_stock_symbols = [
  "RELIANCE.NSE", "TCS.NSE", "HDFCBANK.NSE", "INFY.NSE", "ICICIBANK.NSE", "HINDUNILVR.NSE", "SBIN.NSE", "WIPRO.NSE",
  "BHARTIARTL.NSE", "ITC.NSE", "LTIM.NSE", "BAJFINANCE.NSE", "KOTAKBANK.NSE", "HCLTECH.NSE", "AXISBANK.NSE",
  "TATAMOTORS.NSE", "MARUTI.NSE", "SUNPHARMA.NSE", "ASIANPAINT.NSE", "LT.NSE", "TATASTEEL.NSE", "NTPC.NSE",
  "ULTRACEMCO.NSE", "BAJAJFINSV.NSE", "TITAN.NSE", "NESTLEIND.NSE", "M&M.NSE", "JSWSTEEL.NSE", "POWERGRID.NSE",
  "ADANIPORTS.NSE", "CIPLA.NSE", "ONGC.NSE", "INDUSINDBK.NSE", "DRREDDY.NSE", "BPCL.NSE", "GRASIM.NSE",
  "TATACONSUM.NSE", "HDFCLIFE.NSE", "SBILIFE.NSE", "HEROMOTOCO.NSE"
];
